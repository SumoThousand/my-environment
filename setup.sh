...
# setup SumoThousand/vimrc 
# git@github.com:SumoThousand/vimrc.git
cd vimrc/dotfiles
cp .vimrc ~/
cd -
# install vim plugins
...
# https://github.com/sumothousand/oh-my-zsh
sh -c "$(curl -fsSL https://raw.github.com/sumothousand/oh-my-zsh/master/tools/install.sh)"
