...
echo "installed by sumothousand/my-env."
echo "ONLY run this script if you have"
echo "installed sumothousand/my-env on this machine."
...
# Resets the git configurations set by sumothousand/git-hacker
./git-hacker/hacks/reset-git-config.sh

# remove sumothousand/my-env vim plugins
rm -rf ~/.vim/bundle/

# remove ./vimrc created by sumothousand/my-env
rm ~/.vimrc
touch ~/.vimrc
...
# remove sumothousand/my-env .zshrc
rm ~/.zshrc 
touch ~/.zshrc 
...
echo "Thanks for checking out my environment. --Sumo"
